...
struct vx_renderer
{
    ...
    void (*update_resources_managed)(vx_renderer_t * rend, int worldID, char * buffer_name, lphash_t * resources);
    void (*add_resources_direct)(vx_renderer_t * rend, lphash_t * resources);
    void (*remove_resources_direct)(vx_renderer_t * rend, lphash_t * resources);
    void (*update_buffer)(vx_renderer_t * rend, int worldID, char * buffer_name, int drawOrder, uint8_t * data, int datalen);

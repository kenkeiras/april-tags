...
public class MaxRectifiedView implements SyntheticView
{
    Calibration cal;
    ...
    public MaxRectifiedView(Calibration cal)
    {
        this.cal = cal;

        computeMaxRectifiedRectangle();
        computeOffsetIntrinsics();
    }

    private void computeMaxRectifiedRectangle()
    {
        int x_dp, y_dp;

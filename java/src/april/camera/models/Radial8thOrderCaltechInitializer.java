...
public class Radial8thOrderCaltechInitializer implements CalibrationInitializer
{
    public static boolean verbose = false;

    public Radial8thOrderCaltechInitializer()
    {
    }
                                        ...
                                        TagMosaic tm)
    {
        ...
        return new Radial8thOrderCaltechCalibration(fc, cc, kc, width, height);
    }
    ...
    public ParameterizableCalibration initializeWithParameters(int width, int height,
                                                               double params[])
    {
        return new Radial8thOrderCaltechCalibration(params, width, height);
    }
}

...
public class Radial10thOrderCaltechInitializer implements CalibrationInitializer
{
    public static boolean verbose = false;

    public Radial10thOrderCaltechInitializer()
    {
    }
                                        ...
                                        TagMosaic tm)
    {
        ...
        return new Radial10thOrderCaltechCalibration(fc, cc, kc, width, height);
    }
    ...
    public ParameterizableCalibration initializeWithParameters(int width, int height,
                                                               double params[])
    {
        return new Radial10thOrderCaltechCalibration(params, width, height);
    }
}

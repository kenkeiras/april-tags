...
public class Radial8thOrderCaltechCalibration implements Calibration, ParameterizableCalibration
{
    ...
    public Radial8thOrderCaltechCalibration(double fc[], double cc[], double kc[],
    ...
    public Radial8thOrderCaltechCalibration(Config config)
    {
    ...
    public Radial8thOrderCaltechCalibration(double params[], int width, int height)
    {
        this.width = width;
        this.height = height;

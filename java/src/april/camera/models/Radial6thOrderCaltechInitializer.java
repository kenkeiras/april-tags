...
public class Radial6thOrderCaltechInitializer implements CalibrationInitializer
{
                                        ...
                                        TagMosaic tm)
    {
        ...
        double kc[] = new double[] {  0, 0, 0 };

        return new Radial6thOrderCaltechCalibration(fc, cc, kc, width, height);
    }
    ...
    public ParameterizableCalibration initializeWithParameters(int width, int height,
                                                               double params[])
    {
        return new Radial6thOrderCaltechCalibration(params, width, height);
    }
}

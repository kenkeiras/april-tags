...
public interface VxCameraManager
{
    public static class CameraPosition
    {
        ...
        public double[][] getProjectionMatrix()
        {
            ...
            double pM[][] = VxUtil.gluPerspective(perspective_fovy_degrees, aspect,
                                                  zclip_near, zclip_far);
            double oM[][] = VxUtil.glOrtho(-dist * aspect / 2, dist*aspect / 2, -dist/2, dist/2,
                                           -zclip_far, zclip_far);
        ...
        {
            double rayStart[] = VxUtil.unProject(new double[] { winx, winy, 0 },
                                                 getModelViewMatrix(), getProjectionMatrix(),
                                                 layerViewport);

            double rayEnd[] = VxUtil.unProject(new double[] { winx, winy, 1 },
                                               getModelViewMatrix(), getProjectionMatrix(),
                                               layerViewport);
    ...
    public CameraPosition getCameraPosition(int layerViewport[], long mtime);
